...
| [DDR-11](DDR-11.md) | metrics, observability, prometheus | Prometheus metrics instrumentation: textfile collector pattern for performance and operation metrics, optional HTTP endpoint, evaluation of Push Gateway |
